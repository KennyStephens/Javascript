...
function loadWeather(){
    ...
    var conditionsPath = "http://api.wunderground.com/api/34abcd7a9f5f00e6/conditions/q/"+zip+".json";
    var forecastPath = "http://api.wunderground.com/api/34abcd7a9f5f00e6/forecast/q/"+zip+".json";
